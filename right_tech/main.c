...
//{
	...
	HAL_UART_Receive_IT(&huart1, (uint8_t*)buffer, strlen(buffer), 1000);
	HAL_UART_Transmit_IT(&huart2, (uint8_t*)buffer, strlen(buffer), 1000);

*/
	/*********  CMD+WIFIMODE=1  ********/
	//memset(&buffer[0],0x00,strlen(buffer));
	/*sprintf (&buffer[0], "CMD+WIFIMODE=1\r\n");
	HAL_UART_Transmit_IT(&huart1, (uint8_t*)buffer, strlen(buffer), 1000);
	HAL_UART_Transmit_IT(&huart2, (uint8_t*)buffer, strlen(buffer), 1000);
...
*/
	...
	//memset(&buffer[0],0x00,strlen(buffer));
	/*sprintf (&buffer[0], "CMD+CONTOAP=POCO X3,123456789\r\n");
	HAL_UART_Transmit_IT(&huart1, (uint8_t*)buffer, strlen(buffer), 10000);
	HAL_UART_Transmit_IT(&huart2, (uint8_t*)buffer, strlen(buffer), 10000);
	//memset(&buffer[0],0x00,strlen(buffer));
	HAL_Delay(2000);
	HAL_UART_Receive_IT(&huart1, (uint8_t*)buffer, strlen(buffer), 10000);
	HAL_Delay(500);
	HAL_UART_Transmit_IT(&huart2, (uint8_t*)buffer, strlen(buffer), 10000);
*/
	/********* CMD?WIFI**********/
